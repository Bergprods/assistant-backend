...
class Repository(Generic[T]):
    ...
    This stays generic: no domain rules. Services compose operations.
    """
    ...
    async def list(self, session: AsyncSession, *, filters: Optional[Dict[Any, Any]] = None, limit: Optional[int] = None, offset: int = 0) -> List[T]:
